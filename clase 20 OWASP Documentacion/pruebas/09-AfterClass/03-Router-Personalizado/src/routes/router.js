...
export class MiRouter{
    ...
    get(path, permisos, ...funciones){
        // this.router.get(path, this.misRespuestas, this.handlePolicies(permisos), this.applyCallbacks(funciones))
        this.router.get(path, this.misRespuestas, this.handlePolicies(permisos), funciones)

    }

    post(path, permisos, ...funciones){
        this.router.post(path, this.misRespuestas, this.handlePolicies(permisos), this.applyCallbacks(funciones))
    }

    put(path, permisos, ...funciones){
        this.router.put(path, this.misRespuestas, this.handlePolicies(permisos), this.applyCallbacks(funciones))
    }

    delete(path, permisos, ...funciones){
        this.router.delete(path, this.misRespuestas, this.handlePolicies(permisos), this.applyCallbacks(funciones))
    }
