...
export class MiRouter{
    ...
    get(path, permisos, ...funciones){
        ...
        this.router.get(path , path=='/login'?this.nada:passport.authenticate('jwt',{session:false}),this.misRespuestas, this.handlePolicies(permisos), this.applyCallbacks(funciones))

    }

    post(path, permisos, ...funciones){
        this.router.post(path, path=='/login'?this.nada:passport.authenticate('jwt',{session:false}), this.misRespuestas, this.handlePolicies(permisos), this.applyCallbacks(funciones))
    }
